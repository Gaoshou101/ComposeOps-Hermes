...
import { ArrowDownToLine, Bot, Check, Copy, Eraser, Globe2, MessageCircle, MessageSquare, Pencil, Plus, RefreshCw, ScrollText, Search, Send, ShieldAlert, Sparkles, Square, Trash2, UserRound, Wand2 } from 'lucide-vue-next';
