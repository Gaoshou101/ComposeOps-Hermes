  ...
  <div class="page-shell">
    <div class="page-header">
      <div>
        ...
        <p class="page-subtitle">统一汇聚告警、巡检、部署、回滚、Agent 与工作流事件,作为时间线的单一事实来源</p>
      </div>
...
import { Activity, AlertTriangle, CircleAlert, RefreshCw, Trash2, Workflow } from 'lucide-vue-next';
