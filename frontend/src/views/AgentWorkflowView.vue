...
import { Activity, ArrowDownToLine, Bot, Brain, Check, Copy, Eraser, Globe2, MessageCircle, MessageSquare, Pencil, Plus, RefreshCw, ScrollText, Search, Send, ShieldAlert, Sparkles, Square, Trash2, UserRound, Wand2 } from 'lucide-vue-next';
...
/* 回底浮标 */
.agent-scroll-bottom { position: absolute; right: 26px; bottom: 132px; z-index: 15; display: inline-flex; align-items: center; gap: 5px; padding: 7px 12px; color: #a5f3fc; border: 1px solid #155e75; border-radius: 999px; background: rgba(8,47,73,.92); box-shadow: 0 6px 18px rgba(0,0,0,.4); animation: fade-rise .18s ease; font-size: 11px; }
